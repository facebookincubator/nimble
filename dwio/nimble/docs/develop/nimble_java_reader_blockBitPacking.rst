...
test_generator ( //dwio/nimble/encodings/tests:test_generator ) produces artifact files for each (encoding, dataType, rowCount) combination:
...
.. code-block:: text
    ...
    buck2 run //dwio/nimble/encodings/tests:test_generator \
