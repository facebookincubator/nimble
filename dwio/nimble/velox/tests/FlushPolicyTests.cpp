...
TEST_F(ChunkFlushPolicyTest, InitialNoMemoryPressure) {
  ChunkFlushPolicy policy(
      std::make_shared<const ChunkFlushPolicyConfig>(ChunkFlushPolicyConfig{
          .writerMemoryHighThreshold = 1000,
          .writerMemoryLowThreshold = 500,
...
TEST_F(ChunkFlushPolicyTest, StripeSizeTriggersFlush) {
  ChunkFlushPolicy policy(
      std::make_shared<const ChunkFlushPolicyConfig>(ChunkFlushPolicyConfig{
          .writerMemoryHighThreshold = 2000,
          .writerMemoryLowThreshold = 500,
          .targetStripeSizeBytes = 800,
          .compressionRatioFactor = 1.5}));
