...
/// IndexWriter encodes index keys from input data during write time and
...
class IndexWriter {
 public:
  ...
  /// @param context Writer context providing memory pool and other resources.
  ...
  std::optional<Stream> finishStripe(Buffer& buffer);
 ...
 private:
  ...
  /// Encodes a single chunk and populates the Chunk struct.
