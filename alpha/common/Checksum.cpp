...
class Xxh3_64Checksum : public Checksum {
 public:
  Xxh3_64Checksum() : state_{XXH3_createState()} {
    ALPHA_DASSERT(state_ != nullptr, "Failed to initialize Xxh3_64Checksum.");
    reset();
  }
  ...
  void update(std::string_view data) override {
    ...
    ALPHA_ASSERT(result != XXH_ERROR, "XXH3_64bits_update error.");
  }
 ...
 private:
  ...
  void reset() {
    ...
    ALPHA_ASSERT(result != XXH_ERROR, "XXH3_64bits_reset error.");
  }
};
} // namespace
